...
%
%-------------------------------------------------------------------------
\titulo{Integração do WoTPy com Grafos de Conhecimento para Aprimorar a Interoperabilidade na Internet das Coisas (IoT)}
...
\input{sections/02_glossario}
\input{sections/03_resumo}
\input{sections/04_abstract}
\input{sections/05_lista}

% ----------------------------------------------------------
% ELEMENTOS TEXTUAIS
% ----------------------------------------------------------
\textual
\input{sections/06_introducao}
\input{sections/07_objetivo}
\input{sections/08_revisao}
\input{sections/09_metodologia}
\input{sections/10_resultado}
\input{sections/11_discussao}
